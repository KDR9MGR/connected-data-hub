    ...
    return (
      <div className="bg-stone p-10 rounded-3xl text-center">
        ...
        <p className="text-ink/60 max-w-md mx-auto">
          A member of our clinical team will reach out within one working day. For urgent matters
          please message us on WhatsApp.
        </p>
        <button
          onClick={() => setSent(false)}
          className="mt-8 text-[11px] uppercase tracking-[0.22em] text-sage border-b border-sage/40 pb-0.5"
        >
    ...
    <form onSubmit={onSubmit} className="bg-stone p-8 md:p-10 rounded-3xl space-y-6">
      ...
      <Field label="Body (Mandatory)" error={errors.body}>
        <textarea
          ...
          placeholder="Briefly describe your symptoms, history and goals…"
        />
      </Field>
