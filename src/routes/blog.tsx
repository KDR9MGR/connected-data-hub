  ...
  head: () => ({
    meta: [
      { title: "Journal — Araya Veda" },
      {
        name: "description",
        content:
          "Clinical notes, case studies and essays on Ayurvedic medicine, prevention and lifestyle from the Araya Veda team.",
      },
      { property: "og:title", content: "Journal — Araya Veda" },
      {
        property: "og:description",
        content: "Essays and clinical case studies from our Ayurvedic team.",
      },
    ],
  }),
  component: Page,
    ...
    <article className="pt-32 md:pt-40 pb-24 px-6">
      ...
      <section className="max-w-7xl mx-auto">
          ...
          {posts?.map((p) => (
            ...
            >
              <div className="grid md:grid-cols-12 gap-6 items-baseline">
                <div className="md:col-span-2 text-[10px] uppercase tracking-[0.22em] text-sage/70">
                  {formatDate(p.published_at)}
                </div>
                <div className="md:col-span-2 text-[10px] uppercase tracking-[0.22em] text-gold">
                  {p.category}
                </div>
                <h3 className="md:col-span-6 text-2xl md:text-3xl font-serif group-hover:text-gold transition-colors">
                  {p.title}
                </h3>
        ...
        {!isLoading && posts?.length === 0 && (
          <div className="text-center text-ink/50 py-24 text-sm">
